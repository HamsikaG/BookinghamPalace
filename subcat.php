<?php session_start();
	...
	{
		header("location:booklist.php?subcatid=".$row1['subcat_id']."&subcatnm=".$row1["subcat_nm"]."&chk=".$option);
							...
							<div class="entry">
								...
								<?php
									Do
									{
										...
										echo '<li><a href="booklist.php?subcatid='.$row1['subcat_id'].'&subcatnm='.$row1["subcat_nm"].'"&chk=".$option">'.$row1['subcat_nm'].'</a></li>';
