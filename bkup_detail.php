						...
						<!-- start content -->
							...
							<!-- start review -->	
										...
										<table border="0" width="100%">
												 ...
												 <tr align="center" bgcolor="#EEE9F3">
													 <td>Help others! Write a review</td>
								...
								<form role="form" action="process_review.php" method="POST">
								
                                <div class="form-group">
                                    <input type="text" onBlur="check()" placeholder="Review Title*" name="rvwtitle" class="form-control">
									<tr><td>&nbsp;</tr>
                                </div>
                                <div class="form-group">
                                    <textarea placeholder="Your Review*" name="rvw" class="form-control" rows="3"></textarea>
                                </div>
                                ...
                                <div class="form-group pull-left">
                                   <!-- <a input type="submit" class="btn btn-default btn-active ">Submit</a></div> -->
