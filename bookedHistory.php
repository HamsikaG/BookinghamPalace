<?php session_start();
	...
	$q= "select * from booking where uname = '$usr'";
...
<head>
		...
		<?php echo "<script type='text/javascript'>alert(' Hi $usr.. , Congratulations.Your have successfully booked the book with Title: $book .Please ensure to collect your book within 24 hours.');</script>";?>	;
		<?php
...
<div id="page">
					...
					<div id="content">
						<div class="post">
							<h1 class="title">  Welcome to your Booked History!!!
							...
							<div class="entry">
								...
								Please find below books booked by you..!!!								
								 </font></strong><br><br> 
								</p>
